...
public class website_all_links extends Setup {
	...
	public void Ebooks() throws Throwable {	
		WebElement eBooks = wait.until(ExpectedConditions.elementToBeClickable(By.cssSeletor("#header_menu > ul > li:nth-child(9) > a")));
		clear_cache();
		Thread.sleep(3000);
		eBooks.click();
		log.info("EBOOKS");
	...
	public void Research_Services_Page() throws Throwable {
		WebElement Research_footer= wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@class='nav-link'][contains(.,'Research Services')]")));
		Thread.sleep(3000);
		clear_cache();
